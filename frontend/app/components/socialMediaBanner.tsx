        ...
        <div className="follow-me-wrapper container mb-12 md:mb-24 py-12 md:py-24">
            ...
            <div className="social-media-platform-cards-wrapper w-full flex gap-2 md:gap-4 items-center justify-center relative min-h-[200px]">
                <div className="social-media-platform-card min-w-[200px] min-h-[200px] flex items-center justify-center rounded-2xl
                    ...
                    <i className="fa fa-linkedin bg-gradient-to-r  from-white via-white to-transparent bg-clip-text text-transparent" aria-hidden="true"></i>
                </div>
                <div className="social-media-platform-card min-w-[200px] min-h-[200px] flex items-center justify-center rounded-2xl
                    bg-black backdrop:blur-xl border border-gray-100/20 text-white text-8xl 
                    absolute left-[80%] translate-x-[-80%] top-[50%] translate-y-[-50%] rotate-[-15deg] scale-[0.8]">
                    <i className="fa fa-github bg-gradient-to-l from-white via-white to-transparent bg-clip-text text-transparent" aria-hidden="true"></i>
                </div>
                <div className="social-media-platform-card min-w-[200px] min-h-[200px] flex items-center justify-center rounded-2xl
                    bg-black backdrop:blur-xl border border-gray-100/20 text-white text-8xl 
                    absolute left-[35%] translate-x-[-35%] top-[50%] translate-y-[-50%] rotate-[-15deg] scale-[0.9]">
                    <i className="fa fa-facebook bg-gradient-to-r from-white via-white to-transparent bg-clip-text text-transparent" aria-hidden="true"></i>
                </div>
                <div className="social-media-platform-card min-w-[200px] min-h-[200px] flex items-center justify-center rounded-2xl
                    bg-black backdrop:blur-xl border border-gray-100/20 text-white text-8xl 
                    absolute left-[65%] translate-x-[-65%] top-[50%] translate-y-[-50%] rotate-[15deg] scale-[0.9]">
                    <i className="fa fa-twitter bg-gradient-to-l from-white via-white to-transparent bg-clip-text text-transparent" aria-hidden="true"></i>
                </div>
                <div className="social-media-platform-card min-w-[200px] min-h-[200px] flex items-center justify-center rounded-2xl
                    bg-black backdrop:blur-xl border border-gray-100/20 text-white text-8xl 
            ...
            <p className="alan-sans-400 text-gray-500 mt-2 text-center max-w-[600px] mx-auto">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Debitis, ad explicabo. Ab voluptatem eos consequuntur praesentium suscipit laborum tenetur perferendis.</p>
        </div>
    </section>
  )
}
